    ...
    <main class="page-content">
      <div class="container-fluid">
        ...
        <h1 class="h3 mb-0">
          ...
          <a href="tambah-issue.php" class="btn mr-2 btn-primary btn-sm float-right"><i class="fa fa-plus"></i> Tambah Data</a>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $p->status_task ?></td>
                <td>
                  <a href="detail-projek.php?kode=<?= $p->id_task; ?>" class="btn btn-warning btn-xs mr-1">
                    <i class="fa fa-eye mr-1"></i>Detail
                  </a>
                  <a href="anggota.php?kode=<?= $p->id_task; ?>" class="btn btn-success btn-xs mr-1">
                    <i class="fas fa-users fa-xs mr-1"></i>Anggota
                  </a>
                  <a href="edit-projek.php?kode=<?= $p->id_task ?>" class="btn btn-primary btn-xs mr-1">
                    <i class="fas fa-pencil-alt fa-xs mr-1"></i>Edit
                  </a>
                  <?php if ($d['level'] == "Administrator") { ?>
                    <a class="btn btn-danger btn-xs delete-data" href="delete/hapus-projek.php?kode=<?= $p->id_task; ?>">
